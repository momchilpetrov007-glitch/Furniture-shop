        ...
        <div class="container">
            ...
            <?php else: ?>
                            ...
                            <tbody>
                                <?php foreach ($cart_items as $item): ?>
                                    <tr>
                                        ...
                                        <td><?php echo number_format($item['furniture']['price'], 2); ?> лв.</td>
                                        <td>
                                            <input type="number" 
                                        ...
                                        <td><strong><?php echo number_format($item['subtotal'], 2); ?> лв.</strong></td>
                                        <td>
                ...
                <div class="cart-total">
                    <h3>Обща сума: <?php echo number_format($total, 2); ?> лв.</h3>
