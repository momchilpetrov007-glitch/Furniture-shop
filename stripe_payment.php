...
if (isset($_GET['success']) && $_GET['success'] == '1') {
    ...
    // Изпращане на имейли
    if (isset($_SESSION['pending_order_email']) && isset($_SESSION['pending_order_name'])) {
        sendOrderConfirmationEmail($conn, $order_id, $_SESSION['pending_order_email'], $_SESSION['pending_order_name']);
