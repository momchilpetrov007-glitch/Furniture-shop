...
<body>
    ...
    <div class="form-container">
        ...
        <!-- Тестов админ акаунт (само за development) -->
        <?php if ($_SERVER['SERVER_NAME'] === 'localhost'): ?>
        <div style="margin-top: 2rem; padding: 1rem; background: #E8F5E9; border-radius: 4px; font-size: 0.85rem;">
            <strong>Тестов админ акаунт:</strong><br>
            Потребител: admin<br>
            Парола: admin123
        </div>
        <?php endif; ?>
